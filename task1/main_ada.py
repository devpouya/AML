...
model =svm.SVR(C = 15,  cache_size=2000, coef0=0.0, degree=3, epsilon=0.1,
    gamma='auto_deprecated', kernel='rbf', max_iter=-1, shrinking=True,
    tol=0.001, verbose=False)

from sklearn.ensemble import AdaBoostRegressor
clf = AdaBoostRegressor(base_estimator=model, n_estimators=100, learning_rate=1.0,
...
tuned_parameters = [{'loss':['linear', 'square','exponential'], 'learning_rate':[0.01,0.1,1.0]}]
